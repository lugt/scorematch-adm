						...
						<table class="table table-bordered table-striped table-condensed">
							...
							<tbody id="table_data">
								...
								<tr>
									...
									<td><#if globalDict['answer']?exists && globalDict['answer'][item.answer]?exists> ${globalDict['answer'][item.answer]!} <#else> ${item.answer!} </#if></td>
									<td><#if globalDict['isRight']?exists && globalDict['isRight'][item.isRight?c]?exists> ${globalDict['isRight'][item.isRight?c]!} <#else> ${item.isRight!} </#if></td>
									<td><#if globalDict['ansId']?exists && globalDict['ansId'][item.ansId?c]?exists> ${globalDict['ansId'][item.ansId?c]!} <#else> ${item.ansId!} </#if></td>
